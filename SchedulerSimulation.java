...
class Process implements Runnable {
    ...
    private long waitTime; // Total time the process has spent waiting in the ready queue
    ...
    public Process(String name, int burstTime, int timeQuantum, int priority) {
        ...
        this.creationTime = System.currentTimeMillis(); // Set creation time when the process is instantiated
    ...
    public void calculateWaitTime() {
        ...
        waitTime = (currentTime - creationTime) - burstTime; // Update wait time based on current time and creation time
    }
...
public class SchedulerSimulation {
    ...
    private static int contextSwitchCount = 0; // Counter to track the number of context switches
    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445050104;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // Random priority for each process between 1 and 5
            int priority = 1 + random.nextInt(5); // priority generated randomly between 1 and 5
            
            // Create a new process object with a unique name, burst time, time quantum, and priority
            Process process = new Process("P" + i, burstTime, timeQuantum, priority); //added priority to process constructor
        ...
        while (!processQueue.isEmpty()) {
            ...
            contextSwitchCount++; // Increment context switch count for each process switch
            ...
            if (!process.isFinished()) {
                ...
                if (!processQueue.isEmpty()) {
                    ...
                    process.calculateWaitTime(); // Update the wait time for the process after it has completed
                }
            } else {
                // If the process has finished, calculate its wait time
                process.calculateWaitTime();
            }
        }
        
        // End of the scheduler simulation

        System.out.println(Colors.BOLD + Colors.YELLOW + "Total context switches: " + contextSwitchCount + Colors.RESET); //shows the total number of context switches that occurred during the simulation
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,Map<Thread, Process> processMap) {
        ...
        System.out.println(Colors.BLUE + "  ➕ " + Colors.BOLD + Colors.CYAN + process.getName() +
                         Colors.RESET + Colors.WHITE + " (Priority: " + process.getPriority() + ")"+ //changed to show priority in the message
